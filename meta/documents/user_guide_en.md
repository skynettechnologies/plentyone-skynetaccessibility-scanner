# SkynetAccessibility Scanner: PlentyOne Plugin
...
Alternatively, you can run below command to complete the installation from the command line.
...
## License
SkynetAccessibility Scanner is licensed under the GNU General Public License - see the [AGPL-3.0](LICENSE) file for details.
